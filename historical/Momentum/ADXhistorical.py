...
class AverageDirectionalMovement:
    ...
    def generate_chart(self):
        ...
        fig.add_trace(go.Candlestick(x=time, open=openVar, high=highVar, low=lowVar, close=closeVar, name="Stock Price"), row=2, col=1)

        fig.add_trace(go.Scatter(x=time, y=adx, mode="lines", name="Average Directional Movement Index", line=dict(color="blue")), row=1, col=1)
        fig.add_trace(go.Scatter(x=time, y=minus_di, mode="lines", name="Negative Directional Index", line=dict(color="red")), row=1, col=1)
        fig.add_trace(go.Scatter(x=time, y=plus_di, mode="lines", name="Positive Directional Index", line=dict(color="green")), row=1, col=1)
